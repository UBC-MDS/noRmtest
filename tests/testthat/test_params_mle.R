...
test_that("Invalid input types will throw error",{
  ...
  expect_error(data.frame("var1" = c(1,2,"3", "4")))
  expect_error(matrix(c(TRUE, TRUE, FALSE, FALSE), ncol = 2, nrow = 2))
})
